...
const ExeCom = () => {
    const members = [
        ...
        { name: 'Colin Jimmy', role: 'Computer Society Chair', image: '/assets/images/execom/Colin Jimmy.jpg' },
        { name: 'Ronal Shoey George', role: 'Computer Society Secretary', image: '/assets/images/execom/Ronal George.jpg' },
        { name: 'Silda Sholly', role: 'Communications Society Chair', image: '/assets/images/execom/Silda.JPG' },
        { name: 'Shraddha Sasikumar', role: 'Communications Society Secretary', image: '/assets/images/execom/Shraddha Sasikumar.jpg' },
        { name: 'Mathew Vinu Benny', role: 'Robotics and Automation Society Chair', image: '/assets/images/execom/Mathew Vinu Benny.jpg' },
        { name: 'Neha Savy', role: 'Robotics and Automation Society Secretary', image: '/assets/images/execom/Neha Savy.jpg' },
        { name: 'Akhil Sebastian', role: 'Power and Energy Society Chair', image: '/assets/images/execom/Akhil Sebastian.jpg' },
        { name: 'Jes Gigo', role: 'Power and Energy Society Secretary', image: '/assets/images/execom/JesGigo.jpg' },
        { name: 'Amritha M', role: 'Industry Applications Society Chair', image: '/assets/images/execom/Amritha M.jpg' },
        { name: 'Ameena R', role: 'Industry Applications Society Secretary', image: '/assets/images/execom/Ameena.jpg' },
        ...
        { name: 'Oliviya Jain', role: 'Signal Processing Society Chair', image: '/assets/images/execom/Oliviya Jain.jpg' },
        { name: 'Naveen Prasad', role: 'Signal Processing Society Secretary', image: '/assets/images/execom/Naveen Prasad.jpg' },
